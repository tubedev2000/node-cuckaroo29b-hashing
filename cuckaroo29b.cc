...
NAN_MODULE_INIT(init) {
	Nan::Set(target, Nan::New("cuckaroo29b").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(cuckaroo29b)).ToLocalChecked());
	Nan::Set(target, Nan::New("cycle_hash").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(cycle_hash)).ToLocalChecked());
}

NODE_MODULE(cuckaroo29b, init)
